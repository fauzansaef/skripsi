...
var KTBootstrapDaterangepicker = function () {
    ...
    var demos = function () {
        ...
        $('#kt_daterangepicker_2').daterangepicker({
         ...
         $('#kt_daterangepicker_2_modal').daterangepicker({
            ...
            $('#kt_daterangepicker_2 .form-control').val( start.format('MM-DD-YYYY') + ' / ' + end.format('MM-DD-YYYY'));
        });
    ...
    var validationDemos = function() {
        ...
        $('#kt_daterangepicker_2_validate').daterangepicker({
            ...
            $('#kt_daterangepicker_3_validate .form-control').val( start.format('MM-DD-YYYY') + ' / ' + end.format('MM-DD-YYYY'));
        });
