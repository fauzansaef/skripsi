var IndexPerencanaan = function () {
    ...
    var loadTablePerencanaan = function () {
        var tabelPerencanaan = $('#tabelPerencanaan').DataTable({
            "ajax": {
                "url": "/api/v1/perencanaan/versi_aplikasis/by_id_status/2",
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var buttonPerencanaan =
                            ...
                            '</button>';
                        var buttonPerencanaan =
                            '<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 mb-1" title="Review Perencanaan" onclick="reviewPerencanaan('+row['idVersion']+')">\n' +
                            '      <span class="svg-icon svg-icon-3">' +
...
function reviewPerencanaan(id) {
    window.open(window.location.origin + "/perencanaan/reviewperencanaan/"+id, '_blank');
}
