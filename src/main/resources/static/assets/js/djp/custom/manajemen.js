            ...
            "columns": [
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if(userAuthority == 'ROLE_KEPALA_SEKSI') {
                            return'<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="View" onclick="viewKriteriaPegawai(' + row['id'] + ')">\n' +
                        ...
                        else if(userAuthority == 'ROLE_ANALIS') {
