var identity = function(t) {
    ...
    extend = function() {
        var t = {};
        return foreach(argumentsToArray(arguments), (function(e) {
    ...
    mapToArray = function(t, e) {
        var n = [];
        return foreach(t, (function(t, r, i) {
            n.push(e(t, r, i))
        })), n
    },
    mapToObject = function(t, e, n) {
        var r = {};
        return foreach(t, (function(t, i, a) {
    ...
    filter = function(t, e) {
        var n;
        return isArray(t) ? (n = [], foreach(t, (function(t, r, i) {
            e(t, r, i) && n.push(t)
        }))) : (n = {}, foreach(t, (function(t, r, i) {
            e(t, r, i) && (n[r] = t)
        }))), n
    },
    call = function(t, e, n) {
    ...
    mixinPubSub = function(t) {
        var e = {};
        return (t = t || {}).publish = function(t, n) {
            ...
            foreach(e, (function(e) {
                var n = indexOf(e, t); - 1 !== n && e.splice(n, 1)
            }))
        }, t
    };
! function(t) {
    ...
    var e = function(t, e) {
            ...
            return r.getType = function() {
                ...
                var a = r.get();
                e.equalTo(a, n) || r.publish("change", {
                    e: t,
                    domElement: i
                }), n = a
            }, r
        ...
        r = function(t, e) {
            ...
            var n = !0;
            return t.length !== e.length ? n = !1 : foreach(t, (function(t) {
                inArray(e, t) || (n = !1)
            })), n
        },
        i = function(t) {
        ...
        a = function(e) {
            ...
            return a.getType = function() {
                ...
                var e = [];
                return a.$().filter(":checked").each((function() {
                    e.push(t(this).val())
                })), e
            }, a.set = function(e) {
                e = isArray(e) ? e : [e], a.$().each((function() {
                    t(this).prop("checked", !1)
                })), foreach(e, (function(t) {
                    a.$().filter('[value="' + t + '"]').prop("checked", !0)
                }))
            }, i.equalTo = r, a.$().change((function(t) {
        ...
        s = function(t) {
            ...
            }, e.equalTo = r, i.$().change((function(t) {
                e.publishChange(t, this)
            })), i
        },
        l = function(t) {
        ...
        p = function(e) {
            ...
            return i.getType = function() {
                ...
                e ? i.$().filter('[value="' + e + '"]').prop("checked", !0) : i.$().each((function() {
                    t(this).prop("checked", !1)
                }))
            }, i.$().change((function(t) {
                r.publishChange(t, this)
        ...
        g = function(e) {
            var n = {},
                ...
                b = function(e, i) {
                    ...
                    isObject(i) ? n[u.attr("name")] = g[e]({
                        $: u
                    }) : (u.each((function() {
                        -1 === indexOf(a, t(this).attr("name")) && a.push(t(this).attr("name"))
    ...
    t.fn.inputVal = function(e) {
        ...
        return n.is("input, textarea, select") ? void 0 === e ? r[n.attr("name")].get() : (r[n.attr("name")].set(e), n) : void 0 === e ? call(r, "get") : (foreach(e, (function(t, e) {
            r[e].set(t)
        })), n)
...
}(jQuery), $.fn.repeaterVal = function() {
    var t, e, n = function(t) {
        ...
        return /^[0-9]+$/.test(t[0].head) ? (e = [], foreach(r, (function(t) {
            e.push(n(t))
        }))) : (e = {}, foreach(r, (function(t, r) {
            e[r] = n(t)
        }))), e
    };
    return n((t = $(this).inputVal(), e = [], foreach(t, (function(t, n) {
        var r = [];
        "undefined" !== n && (r.push(n.match(/^[^\[]*/)[0]), r = r.concat(map(n.match(/\[[^\]]*\]/g), (function(t) {
            return t.replace(/[\[\]]/g, "")
        }))), e.push({
            val: t,
            key: r
    ...
    return t = t || {}, $(this).each((function() {
        var n = $(this),
            ...
            u = function(t, e) {
                return t.filter((function() {
                    return !e || 0 === $(this).closest(pluck(e, "selector").join(",")).length
                }))
            },
            c = function() {
            ...
            f = u(u($(this).find("[data-repeater-item]"), t.repeaters).first().find("[data-repeater-delete]"), t.repeaters);
        ...
        var s = function() {
            ...
            l = function(e) {
                t.repeaters && e.each((function() {
                    var e = $(this);
                    foreach(t.repeaters, (function(t) {
                        e.find(t.selector).repeater(extend(t, {
                            $parent: e
                        }))
                    }))
                }))
            ...
            h = function(t, e, n) {
                t.each((function(t) {
                    var r = $(this);
                    r.data("item-name", e + "[" + t + "]"), u(r.find("[name]"), n).each((function() {
                        var i = $(this),
                            a = i.attr("name").match(/\[[^\]]+\]/g),
                            c = a ? last(a).replace(/\[|\]/g, "") : i.attr("name"),
                            o = e + "[" + t + "][" + c + "]" + (i.is(":checkbox") || i.attr("multiple") ? "[]" : "");
                        i.attr("name", o), p(n, r, (function(n) {
                            var r = $(this);
                            h(u(r.find("[data-repeater-item]"), n.repeaters || []), e + "[" + t + "][" + r.find("[data-repeater-list]").first().data("repeater-list") + "]", n.repeaters)
                        }))
                    }))
                })), a.find("input[name][checked]").removeAttr("checked").prop("checked", !0)
            };
        h(c(), s(), t.repeaters), l(c()), t.initEmpty && c().remove(), t.ready && t.ready((function() {
            h(c(), s(), t.repeaters)
        }));
        var d, m = (d = function(e, n, r) {
                if (n || t.defaultValues) {
                    var i = {};
                    u(e.find("[name]"), r).each((function() {
                        var t = $(this).attr("name").match(/\[([^\]]*)(\]|\]\[\])$/)[1];
                        i[t] = $(this).attr("name")
                    })), e.inputVal(map(filter(n || t.defaultValues, (function(t, e) {
                        return i[e]
                    })), identity, (function(t) {
                        return i[t]
                    })))
                ...
                p(r, e, (function(t) {
                    var e = $(this);
                    u(e.find("[data-repeater-item]"), t.repeaters).each((function() {
                        var r = e.find("[data-repeater-list]").data("repeater-list");
                        if (n && n[r]) {
                            var i = $(this).clone();
                            e.find("[data-repeater-item]").remove(), foreach(n[r], (function(n) {
                                var r = i.clone();
                                d(r, n, t.repeaters || []), e.find("[data-repeater-list]").append(r)
                            }))
                        } else d($(this), t.defaultValues, t.repeaters || [])
                    }))
                }))
            }, function(e, n) {
                a.append(e), h(c(), s(), t.repeaters), e.find("[name]").each((function() {
                    $(this).inputClear()
        ...
        e = function(t) {
            ...
            v();
            var id = n[0].id;
            if(n.find("[data-repeater-item]").size() === 2){
                if(id === "pihakTerlapor") {
                    n.find("[data-repeater-item]").get(0).getElementsByClassName("deletePelapor")[0].style.display = "block";
                }else{
                    n.find("[data-repeater-item]").get(0).getElementsByClassName("deleteBuktiPendukung")[0].style.display = "block";
                }
            }
            var totalList = n.find("[data-repeater-item]").size();
            var currentDiv = n.find("[data-repeater-item]").get(totalList-1);
            if(id === "pihakTerlapor") {
                currentDiv.getElementsByClassName("deletePelapor")[0].style.display = "block";
            }else{
                currentDiv.getElementsByClassName("deleteBuktiPendukung")[0].style.display = "block";
            }
        })), a.on("click", "[data-repeater-delete]", (function() {
            var e = $(this).closest("[data-repeater-item]").get(0);
            i.call(e, (function() {
                if(n.find("[data-repeater-item]").size() === 2){
                    n.find("[data-repeater-item]").find("[data-repeater-delete]").hide();
                }
